...
class NowPlayingOs extends StatefulWidget {
  ...
  @override
  State<NowPlayingOs> createState() => _NowPlayingOsState();
}

class _NowPlayingOsState extends State<NowPlayingOs> {
    ...
    widget.audioPlayer.currentIndexStream.listen(
      (event) {
        setState(
          () {
            if (event != null) {
              widget.currentIndex = event;
            }
            context
                .read<SongModelProvider>()
                .setId(widget.songModelList[widget.currentIndex].id);
          },
        );
      },
    );
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      widget
                          .songModelList[widget.currentIndex].displayNameWOExt,
