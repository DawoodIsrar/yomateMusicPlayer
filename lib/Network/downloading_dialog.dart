...
class DownloadingDialogV extends StatefulWidget {
  DownloadingDialogV(String this.urlmp3,this.name, {super.key,});
String urlmp3;
String name;
  @override
  _DownloadingDialogVState createState() => _DownloadingDialogVState();
}

class _DownloadingDialogVState extends State<DownloadingDialogV> {
  Dio dio = Dio();
  double progress = 0.0;
