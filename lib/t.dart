...
class MyFileListthum extends StatefulWidget {
  MyFileListthum({Key? key, required this.imgs}) : super(key: key);

  List<File> imgs;
  @override
  State<StatefulWidget> createState() {
    return _MyFileListthum();
  }
}

class _MyFileListthum extends State<MyFileListthum> {
  var files;
  String thumbnail = '';
                        ...
                        child: Stack(children: [
                          ...
                          Column(
                            ...
                            children: [
                              ListTile(
                                title: Text(
                                    widget.imgs[index].path.split('/').last),
                                onTap: () {
                                  Navigator.of(context).push(MaterialPageRoute(
                                      builder: (context) => Sampleplayer(
                                          vp: widget.imgs[index].path)));
                                },
                              )
                            ],
                          ),
